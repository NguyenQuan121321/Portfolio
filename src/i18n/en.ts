const en: Record<string, string> = {
  ...
  "project.finnapi.sim.title": "Interactive Live API Playground",
  "project.finnapi.sim.subtitle": "Type your own email, password, or 6-digit OTP to test the authentication flow step-by-step:",
  "project.finnapi.sim.tab_register": "1. Register User",
  "project.finnapi.sim.tab_login": "2. Login",
  "project.finnapi.sim.tab_totp": "3. Verify TOTP 2FA",
  ...
  "project.finnapi.sim.response_status": "Response Status",
  "project.finnapi.sim.response_latency": "Execution Latency",
  "project.finnapi.sim.response_headers": "Security Response Headers",
  ...
  "contact.subtitle": "Seeking Intern / Fresher Backend Developer opportunities in Hanoi or Remote",
