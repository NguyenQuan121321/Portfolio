const en: Record<string, string> = {
  // Navigation
  "nav.status": "Available for hire · Backend",
  "nav.status_line1": "AVAILABLE FOR HIRE",
  "nav.status_line2": "Backend Developer",
  "nav.status_tooltip": "Click to connect: Available for Fresher / Intern Backend Developer roles (Go & Node.js)",
  "nav.home": "Home",
  ...
  // Chatbot AI
  "chatbot.button_tooltip": "Chat with Jake (Portfolio Hub Agent)",
  "chatbot.title": "Jake AI",
  "chatbot.subtitle": "Portfolio Hub Agent · Go Microservice",
  "chatbot.status_online": "JakeAI Go Backend",
  "chatbot.welcome_msg": "Hello, I am Jake — Portfolio Hub Agent. I'm here to help you explore Quan's backend stack, architecture of FinnApiGo, and interview scheduling.",
  "chatbot.input_placeholder": "Ask Jake anything (e.g. What are Quan's core backend skills?)...",
  ...
  "chatbot.clear_chat": "Clear conversation",
