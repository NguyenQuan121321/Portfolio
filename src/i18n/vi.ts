const vi: Record<string, string> = {
  ...
  "project.finnapi.sim.tab_register": "1. Đăng ký",
  "project.finnapi.sim.tab_login": "2. Đăng nhập",
  "project.finnapi.sim.tab_profile": "3. Lấy Profile",
  ...
  "project.finnapi.sim.input_token": "Lấy accessToken từ Login",
