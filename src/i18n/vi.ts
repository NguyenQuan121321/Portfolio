const vi: Record<string, string> = {
  ...
  // Chatbot AI
  "chatbot.button_tooltip": "Chat với Jake (Portfolio Hub Agent)",
  "chatbot.title": "Jake AI",
  "chatbot.subtitle": "Portfolio Hub Agent · Go Microservice",
  "chatbot.status_online": "JakeAI Go Backend",
  "chatbot.welcome_msg": "Xin chào, tôi là Jake — Portfolio Hub Agent của Quân. Tôi có thể hỗ trợ giải đáp nhanh về kỹ năng backend, kiến trúc dự án FinnApiGo, hoặc cách thức liên hệ phỏng vấn Quân.",
  "chatbot.input_placeholder": "Nhập câu hỏi (ví dụ: Kỹ năng chính của Quân là gì?)...",
  "chatbot.suggest_title": "Gợi ý câu hỏi:",
  ...
  "chatbot.thinking": "Jake AI đang phản hồi...",
  "chatbot.clear_chat": "Làm mới hội thoại",
