const vi: Record<string, string> = {
  ...
  "project.finnapi.sim.title": "API Playground Tương tác Trực tiếp",
  "project.finnapi.sim.subtitle": "Bạn có thể tự nhập tài khoản, mật khẩu hoặc mã OTP 6 số để chạy thử luồng xác thực thực tế:",
  "project.finnapi.sim.tab_register": "1. Đăng ký (Register)",
  "project.finnapi.sim.tab_login": "2. Đăng nhập (Login)",
  "project.finnapi.sim.tab_totp": "3. Xác thực TOTP 2FA",
  ...
  "project.finnapi.sim.response_latency": "Thời gian xử lý",
  "project.finnapi.sim.response_headers": "Header bảo mật trả về",
  "project.finnapi.sim.note_real_api": "Server Render thực tế:",
  ...
  "contact.subtitle": "Tìm kiếm cơ hội thực tập / Fresher Backend Developer tại Hà Nội hoặc Remote",
